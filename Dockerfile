...
LABEL maintainer="chariothy" \
  ...
  org.opencontainers.image.url="https://github.com/chariothy/akshare-docker.git" \
  org.opencontainers.image.source="https://github.com/chariothy/akshare-docker.git" \
  org.opencontainers.image.version=$VERSION \
  org.opencontainers.image.revision=$VCS_REF \
  org.opencontainers.image.vendor="chariothy" \
  org.opencontainers.image.title="akshare" \
  org.opencontainers.image.description="Docker for python with akshare"
